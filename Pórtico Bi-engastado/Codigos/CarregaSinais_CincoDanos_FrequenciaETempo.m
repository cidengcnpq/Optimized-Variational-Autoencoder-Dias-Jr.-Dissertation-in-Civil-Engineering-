function [TrainData,ValidationData,TestData,OptimizationData] = CarregaSinais_CincoDanos_FrequenciaETempo(hz,T,num_col,num_points,num_ac,n_tr,caminho)
...
for k=1:num_col
    ...
    aux2{k,1}=vertcat(aux1s,data_norm_D0{k,1});
end
data_norm_D0=aux2;
...
for k=1:num_col
    ...
    aux1s=abs(fftshift(aux1(1:pts,:)));
   aux2{k,1}=vertcat(aux1s,data_norm_D3{k,1});
end
data_norm_D3=aux2;
clear aux2 aux1 aux1s
