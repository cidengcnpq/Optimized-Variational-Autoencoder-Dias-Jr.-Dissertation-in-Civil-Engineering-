function [acertosD1,errosD1,errosdanos,acertosdanos] = Classificacao_Z24_MSE(N,hpObj,TrainData,ValidationData,TestData,n_test,n_tr,num_ac)
...
for i=1:N
    ...
    dano1=MSE(MSE(1:n_test,1)<=limiar,1);
    a=length(dano1);
    ...
    hold on
    semilogy((3*n_test+1:4*n_test),MSE(3*n_test+1:4*n_test),'Color',[0.4660 0.6740 0.1880],'LineStyle','none','Marker','*')
    hold on
