function[populationCrossoverMutation,bestFitness,avgFitness,bestIndividual, aedP,fitness] = intGeneticOperatorsAED(population, data, mutationProbability,ub,lb, randomProb,executionEnvironment,autoencoderType, encoderLayers, decoderLayers, latentDimension)
% <keywords>
%
...
% - dataPath: path to the data which is used for the HPO
...
% fitness
% - aedP - contains 3 trained AutoencoderDeep with the same hyperparameter
...
%
% History :
% \change{1.0}{05-Nov-2021}
% \change{2.0}{05-Aug-2022}
% \change{3.0}{23-Feb-2023}
% --------------------------------------------------
...
[aedP, fitness] = intEvaluation3CVAED(data,population,executionEnvironment,autoencoderType, encoderLayers, decoderLayers, latentDimension);
